from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QWidget, QVBoxLayout, QHBoxLayout, QGridLayout, QPushButton, QSizePolicy, QLineEdit
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.setWindowIcon(QIcon("Smug Owl.png"))
